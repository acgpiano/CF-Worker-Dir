 ...
 */
 const config = {
  title: "UFC导航", //write your website title
  ...
  lists: [
    //Url list
    {
      ...
      list: [
        {
          url: "https://json.0025.top/",
          name: "JSON工具"
        },
        {
          url: "https://tools.0025.top/excel2json/",
          name: "Excel转JSON"
        },
        {
        ...
        {
          url: "https://cr.console.aliyun.com/#/imageList",
          name: "阿里容器镜像",
...
function renderIndex() {
  const footer = el(
    "footer",
    [],
    el("div", ['class="footer"'], "UFC导航&copy;")
  );
